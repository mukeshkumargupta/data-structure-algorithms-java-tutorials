package com.interview.greedy.G_InsertIntervalPattern;
...
public class A_InsertInterval {
    ...
    Memory Usage: 44.5 MB, less than 29.72% of Java online submissions for Insert Interval
        ...
        while(i < n && intervals[i][1] < newInterval[0]) {//interval end, less than new interval end
        ...
        int ind = 0;
        for (int[] elm: result) {
            arrayResult[ind][0] = elm[0];
            arrayResult[ind][1] = elm[1];
            ind++;
    ...
    public int[][] insertSortMethod(int[][] intervals, int[] newInterval) {
            /*
             * Runtime: 2 ms, faster than 58.75% of Java online submissions for Insert Interval.
    Memory Usage: 44.5 MB, less than 29.72% of Java online submissions for Insert Interval
             */
