...
import com.interview.graph.Point;
...
public class A_C_MinimumStepsToReachTargetByAKnight {
    ...
    public static void main(String args[]){
        A_C_MinimumStepsToReachTargetByAKnight mstr = new A_C_MinimumStepsToReachTargetByAKnight();
        int knightPos[] = { 0, 0 }; 
        int targetPos[] = { 29, 29 };
        
        int distance = mstr.minimumStepsToReachTargetByAKnightDfs(knightPos, targetPos, 30);
        System.out.println(distance);
        mstr = new A_C_MinimumStepsToReachTargetByAKnight();//Not required to create new memory
