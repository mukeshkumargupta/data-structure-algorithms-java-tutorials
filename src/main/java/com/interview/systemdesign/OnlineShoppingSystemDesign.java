...
public class OnlineShoppingSystemDesign {
    ...
    /*
     * ProductCategory, Product, and ProductReview: Here are the classes related to
     * a product:
     */
    ...
    /*
     * ShoppingCart, Item, Order, and OrderLog: Users will add items to the shopping
     * cart and place an order to buy all the items in the cart.
     */
