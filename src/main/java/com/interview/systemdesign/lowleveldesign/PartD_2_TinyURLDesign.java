...
public class PartD_2_TinyURLDesign {
 ...
 // Function to generate a short url from integer ID  
    ...
    public static void main(String[] args) {
        ...
        String tinyUrl = PartD_2_TinyURLDesign.idToShortURL("https://www.geeksforgeeks.org/md5-hash-in-java/");
        System.out.println(tinyUrl);
        long number = PartD_2_TinyURLDesign.shortURLtoID(tinyUrl);
