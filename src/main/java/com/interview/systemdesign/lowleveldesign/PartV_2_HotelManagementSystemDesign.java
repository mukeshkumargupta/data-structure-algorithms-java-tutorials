...
import java.util.*;
public class PartV_2_HotelManagementSystemDesign {
    ...
    /*
     * Account, Person, Guest, Receptionist, and Server: These classes represent the
     * different people that interact with our system: or simplicity, we are not
    ...
    /*
     * Hotel and HotelLocation: These classes represent the top-level classes of the
     * system:
     */
    ...
    /*
     * Room, RoomKey, and RoomHouseKeeping: To encapsulate a room, room key, and
     * housekeeping:
     * 
     */
    ...
    /*
     * RoomBooking and RoomCharge: To encapsulate a booking and different charges
     * against a booking:
     */
