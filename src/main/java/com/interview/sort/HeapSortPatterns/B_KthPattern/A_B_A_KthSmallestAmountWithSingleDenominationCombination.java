...
For a number mid, count how many distinct amounts ≤ mid can be formed using coin * x.

Key Idea:
For a coin c, the number of values ≤ mid is mid / c.
Total count = sum over all coins.
Time Complexity:
Binary search range: log(1e18) ≈ 60
