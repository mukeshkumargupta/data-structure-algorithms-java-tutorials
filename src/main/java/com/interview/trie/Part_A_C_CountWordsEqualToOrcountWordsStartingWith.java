 ...
 */
public class Part_A_C_CountWordsEqualToOrcountWordsStartingWith {
    // Define a struct for
    ...
    public static void main(String[] args) {
        Part_A_C_CountWordsEqualToOrcountWordsStartingWith trie = new Part_A_C_CountWordsEqualToOrcountWordsStartingWith();
        trie.insert("apple");
        trie.insert("app");
