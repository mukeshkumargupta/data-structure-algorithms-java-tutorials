...
public class A_L6RecursiononSubsequencesPrintingSubsequences {
    ...
    public static void main(String[] args) {
        ...
        int[] input = {1,2,3};
        A_L6RecursiononSubsequencesPrintingSubsequences instance = new A_L6RecursiononSubsequencesPrintingSubsequences();
