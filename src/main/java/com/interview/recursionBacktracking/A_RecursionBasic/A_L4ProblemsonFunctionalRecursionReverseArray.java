 ...
 */
public class A_L4ProblemsonFunctionalRecursionReverseArray {
    ...
    public static void main(String[] args) {
        ...
        A_L4ProblemsonFunctionalRecursionReverseArray instance = new A_L4ProblemsonFunctionalRecursionReverseArray();
        /*int[] input = {1,2,3,4,5};
