 ...
 *
    ...
    Use two pointers, odd and even, to track nodes in the odd and even positions.
    odd starts at the first node, and even starts at the second node.
    Maintain an additional pointer, evenHead, to remember the head of the even list so that we
    * can link it to the tail of the odd list at the end.
    Iteration:
    ...
    If the list has less than 3 nodes, the order remains unchanged.
 */
