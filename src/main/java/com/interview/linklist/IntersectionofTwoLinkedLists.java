...
Memory Usage: 41.8 MB, less than 72.75% of Java online submissions for Intersection of Two Linked Lists.
         * 
         */
    ...
    public ListNode getIntersectionTreeNode1(ListNode headA, ListNode headB) {
        //98% runtime
        ...
        ListNode firstP = headA;
        ListNode secondP = headB;
        if (firstLinkListBig) {
            while(diff > 0) {
