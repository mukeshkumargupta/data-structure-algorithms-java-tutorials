...
*/
public class PartB_ShortestPathDAG {
    ...
    private static class DFSApproach {
        ...
        public static void main(String[] args) {
            ...
            DFSApproach dfsApproach = new DFSApproach();
            System.out.println(Arrays.toString(dfsApproach.shortestPath(N1, M1, edges1))); // Output: [0, 2, 1, -1]

            int N2 = 6;
            int M2 = 7;
            int[][] edges2 = {{0, 1, 2}, {0, 4, 1}, {4, 5, 4}, {4, 2, 2}, {1, 2, 3}, {2, 3, 6}, {5, 3, 1}};
            System.out.println(Arrays.toString(dfsApproach.shortestPath(N2, M2, edges2))); // Output: [0, 2, 3, 6, 1, 5]
        }
    }
