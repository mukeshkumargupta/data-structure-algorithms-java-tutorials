 ...
 *         Category: Medium, Must
 *         Know Video: https://www.youtube.com/watch?v=kXy0ABd1vwo&t=413s
 * Related:
 ...
 */
public class PartB_B_CourseSchedule {
    ...
    public static void main(String[] args) {
        PartB_B_CourseSchedule scheduler = new PartB_B_CourseSchedule();
