...
public class Immutable2DSumRangeQuery {
    ...
    public NumMatrix(int[][] matrix) {
        /*
         * Runtime: 148 ms, faster than 83.29% of Java online submissions for Range Sum Query 2D - Immutable.
Memory Usage: 135 MB, less than 9.08% of Java online submissions for Range Sum Query 2D - Immutable.
         */
        int R = matrix.length;
