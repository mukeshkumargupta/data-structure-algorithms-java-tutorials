 ...
 * https://leetcode.com/problems/solving-questions-with-brainpower/ Medium
 * https://leetcode.com/problems/count-number-of-ways-to-place-houses/ Medium
 * https://leetcode.com/problems/house-robber-iv/ Medium
 * https://leetcode.com/problems/mice-and-cheese/ Medium
 * https://leetcode.com/problems/largest-element-in-an-array-after-merge-operations/ Medium
 * 
...
0 <= nums[i] <= 400
 */
public class A_MaxSumForNonAdjacentElements {
    ...
    public static void main(String args[]) {
        A_MaxSumForNonAdjacentElements msn = new A_MaxSumForNonAdjacentElements();
