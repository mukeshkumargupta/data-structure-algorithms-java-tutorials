...
public class BoundaryTraversalAntiClockWise {
    ...
    public void traversalAntiClockWise(TreeNode root){
    ...
    public static void main(String args[]){
        ...
        head = bt.addTreeNode(25, head);
        BoundaryTraversalAntiClockWise bd = new BoundaryTraversalAntiClockWise();
        bd.traversalAntiClockWise(head);
    }
}
