...
public class RemoveDuplicatesfromSortedArray {
    public int removeDuplicates(int[] nums) {
        /*
         * Runtime: 1 ms, faster than 87.37% of Java online submissions for Remove Duplicates from Sorted Array.
Memory Usage: 40.6 MB, less than 59.74% of Java online submissions for Remove Duplicates from Sorted Array.
         */
