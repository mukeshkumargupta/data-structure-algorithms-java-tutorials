...
public class IsGraphBipartite {
    //TC O(number of nodes + number of edges)
    // SC O(number of niodes) for colour array and stack for dfs
    public boolean isBipartite(int[][] graph) {
        /*
         * Runtime: 0 ms, faster than 100.00% of Java online submissions for Is Graph Bipartite?.
Memory Usage: 43.1 MB, less than 82.78% of Java online submissions for Is Graph Bipartite?.
         */
        // here adjacency list is given in unput
